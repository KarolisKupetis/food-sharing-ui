...
Geocode.setApiKey("AIzaSyAhz9WAe5ryujbC6fHm0G9S7mWLRMa4KiU");
Geocode.enableDebug();
...
//     google: object;
//     zoom: number;
//     onLatchange: (newLat: number, newLng: number) => void;
// }
//
// interface MapState {
//     address: string;
...
export default class Map extends React.Component {
    ...
    render() {
        ...
        if (this.props.center.lat !== undefined) {
            ...
            map = <div>
                <AsyncMap
                    googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyAhz9WAe5ryujbC6fHm0G9S7mWLRMa4KiU&libraries=places"
                    loadingElement={
